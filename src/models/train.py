...
if __name__ == '__main__':
    ...
    path = os.getcwd()
    vendas = pd.read_csv(path + '/data/processed/vendas.csv')
    ...
    future.to_csv(path + '/data/processed/future.csv', index=False)
    ...
    model.fit(X, y, horizon=horizon, save_path=path + '/models/xgb.pkl')